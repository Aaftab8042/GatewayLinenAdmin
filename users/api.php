...
/*
|--------------------------------------------------------------------------
| GatewayLinen - Users + Roles REST API
|--------------------------------------------------------------------------
|
| File:
...
function userRow(array $row): array
{
    return [
        ...
        "isWholesaleApproved" =>
            (bool)(
                $row["IsWholesaleApproved"]
                ?? false
            ),

        "wholesaleDiscountPct" =>
            isset($row["WholesaleDiscountPct"])
                ? (float)$row["WholesaleDiscountPct"]
                : 0,

        "creditLimit" =>
            isset($row["CreditLimit"])
                ? (float)$row["CreditLimit"]
                : 0,
...
if ($method === 'GET') {
    ...
    */
    ...
    apiResponse(
        false,
        "Invalid entity. Use users or roles.",
        null,
        400
    );
}
...
if ($method === 'POST') {
    ...
    */
    ...
    if (
        ...
        apiResponse(
            false,
            "Invalid entity. Use user or role.",
            null,
            400
        );
    }
    ...
    if (
        ...
        */
        ...
        if (
            ...
            $wholesaleDiscountPct > 100
        ) {

            apiResponse(
                false,
                "WholesaleDiscountPct must be between 0 and 100.",
                null,
                422
            );
        }
        ...
        */
        ...
        $insertSql = "
            ...
            OUTPUT
                ...
                INSERTED.TaxNumber,
                INSERTED.IsWholesaleApproved,
                INSERTED.WholesaleDiscountPct,
                INSERTED.CreditLimit,
                INSERTED.IsTaxExempt,
    ...
    if (
        ...
        */
        ...
        if ($deleteStmt === false) {
            ...
            apiResponse(
                false,
                "Unable to delete user. Check foreign-key dependencies.",
                null,
                409
            );
        }
